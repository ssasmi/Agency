...
// Filter gallery
const butt = document.querySelectorAll('.butt-filter')
...
function filterStyle(category, items) {

    if (document.querySelectorAll('.even-category')) {
        _removeClasses(document.querySelectorAll('.card-gallery.even-category'), "even-category");
    }

    if (document.querySelectorAll('.odd-category')) {
        _removeClasses(document.querySelectorAll('.card-gallery.odd-category'), "odd-category");
    }

    const filtersRegular = Array.from(items).filter(function (item, index, self) {
        return item.classList.contains(category)
    })
    for (var i = 0; i < filtersRegular.length; i += 1) {

        if (i % 2 !== 0) {

            filtersRegular[i].classList.add('even-category')
            
        } else {

            filtersRegular[i].classList.add('odd-category')
        }
    }
...
buttons.forEach((button) => {
    button.addEventListener('click', () => {
        ...
        filterStyle(currentCategory, cards)
    })
})
...
document.querySelector('.button-filter').classList.add('active-button')

function documentActions(e) {
    const targetElement = e.target;
    if (targetElement.classList.contains('button-filter')) {
        targetElement.classList.add('active-button')
    }

    if (document.querySelectorAll('.button-filter.active-button').length > 1) {
        _removeClasses(document.querySelectorAll('.button-filter.active-button'), "active-button");
        targetElement.classList.add('active-button')
    }
...
if (document.querySelector('.slider-quotes')) {
	let slider_quotes = new Swiper('.slider-quotes', {
		...
		grabCursor: true,
		navigation: {
				nextEl: '.slider-quotes__arrow.slider-quotes__arrow--left',
				prevEl: '.slider-quotes__arrow.slider-quotes__arrow--right',
			},
	});
}
